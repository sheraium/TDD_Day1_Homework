...
{
    [TestClass()]
    public class DataAnalyzerTestsV2
    {
        private DataAnalyzerV2<Product> CreateSUT()
        {
            return new DataAnalyzerV2<Product>(this.CreateTestData());
        }
        ...
        public void SelectSumTest_select_3_Column_Cost_return_6_15_24_21()
        {
            ...
            var actualSum = sut.Groupby(3).GetSum("Cost");
        ...
        public void SelectSumTest_select_4_Column_Revenue_return_50_66_60()
        {
            ...
            var actualSum = sut.Groupby(4).GetSum("Revenue");
        ...
        public void SelectSumTest_select_MinusNumber_throw_ArgumentException()
        {
            ...
            Action act = () => sut.Groupby(-1).GetSum("Cost");
        ...
        public void SelectSumTest_select_NotExistColumn_throw_ArgumentException()
        {
            ...
            Action act = () => sut.Groupby(3).GetSum("NotExist");
        ...
        public void SelectSumTest_select_0_return_0()
        {
            ...
            var actualSum = sut.Groupby(0).GetSum("Cost");
